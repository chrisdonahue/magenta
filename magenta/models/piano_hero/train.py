...
def main(unused_argv):
  ...
  if cfg.stp_emb_iq and cfg.train_loss_iq_range_scalar > 0:
    loss += cfg.train_loss_iq_range_scalar * model_dict["stp_emb_iq_range_penalty"]
  if cfg.stp_emb_iq and cfg.train_loss_iq_contour_scalar > 0:
    loss += cfg.train_loss_iq_contour_scalar * model_dict["stp_emb_iq_contour_penalty"]
  if cfg.stp_emb_iq and cfg.train_loss_iq_deviate_scalar > 0:
    loss += cfg.train_loss_iq_deviate_scalar * model_dict["stp_emb_iq_deviate_penalty"]
